...
public class barcodereader extends AppCompatActivity implements ZXingScannerView.ResultHandler {
    ...
    private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
        new android.app.AlertDialog.Builder(barcodereader.this)
                .setMessage(message)
    ...
    public void handleResult(Result result) {
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                firebase.child(email).child("Contacts").child(myResult).setValue("");
                firebase.child(myResult).child("Contacts").child(email).setValue("");
                scannerView.resumeCameraPreview(barcodereader.this);
